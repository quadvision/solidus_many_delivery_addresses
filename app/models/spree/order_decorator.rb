  ...
  def check_line_items_quantities
    self.line_items.each do |line_item|
      ...
      unless line_item.quantity == line_item_addresses_quantity
        line_item.errors.add(:quantity, I18n.t('activerecord.errors.models.spree/line_item.attributes.quantity.line_item_quantity_not_equal_to_line_item_addresses_quantities', line_item_addresses_quantity: line_item_addresses_quantity))
      end
    end
    true
  end
